...
export default function Card({cca3 ,population, region, capital, pays, drapeau, favoris, setFavoris}) {
    ...
    return(
        <div onClick={()=> navigate(`/details/${cca3}`)} className="Card">
            <div className="cardTop">
                <img src={drapeau} alt="" />
                <svg onClick={(e)=> HandleClick(e, cca3)} class={`w-6 h-6 text-gray-800 dark:text-white ${favoris.includes(cca3) ? "active" : ""}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
